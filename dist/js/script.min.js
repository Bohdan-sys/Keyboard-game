...
/* harmony export */ });
/* harmony import */ var _list__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./list */ "./src/js/components/list.ts");
/* harmony import */ var _popup__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./popup */ "./src/js/components/popup.ts");
...
class AddTextForm {
    ...
    init() {
        if (this.element) {
            ...
            this.popUp = new _popup__WEBPACK_IMPORTED_MODULE_1__.Popup(document.querySelector('.js-popup'));
            this.list = new _list__WEBPACK_IMPORTED_MODULE_0__.List(document.querySelector('.js-list'));
            this.createEvents();
        }
    }
    createEvents() {
...
/* harmony export */ });
/* harmony import */ var _card__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./card */ "./src/js/components/card.ts");
...
class List {
    ...
    getCardInfo() {
        this.listItem?.forEach(item => new _card__WEBPACK_IMPORTED_MODULE_0__.Card(item));
    }
}
