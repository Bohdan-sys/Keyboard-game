...
module.exports = __webpack_require__(/*! ./lib/LanguageDetect */ "./node_modules/languagedetect/lib/LanguageDetect.js");
...
var dbLang = __webpack_require__(/*! ../data/lang.json */ "./node_modules/languagedetect/data/lang.json")
  , Parser = __webpack_require__(/*! ./Parser */ "./node_modules/languagedetect/lib/Parser.js")
  , ISO639 = __webpack_require__(/*! ./ISO639 */ "./node_modules/languagedetect/lib/ISO639.js");
...
var dbUnicodeBlocks = __webpack_require__(/*! ../data/unicode_blocks.json */ "./node_modules/languagedetect/data/unicode_blocks.json");
...
/* harmony export */ });
/* harmony import */ var languagedetect__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! languagedetect */ "./node_modules/languagedetect/index.js");
...
/* harmony import */ var _utils_db__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/db */ "./src/js/utils/db.ts");
...
class List {
    ...
    constructor(element) {
        ...
        this.data = [];
        this.lngDetector = new (languagedetect__WEBPACK_IMPORTED_MODULE_0___default())();
        this.classes = {
    ...
    async createList() {
        ...
        this.data = await (0,_utils_db__WEBPACK_IMPORTED_MODULE_1__.getFromDb)();
        this.data?.forEach((element) => this.createListItem(element));
    }
    createEvents(e) {
        ...
        if (target.classList.contains(removeBtn) && cardElementId) {
            (0,_utils_db__WEBPACK_IMPORTED_MODULE_1__.deleteFromDb)(cardElementId);
            listElement.remove();
            this.clearStorage();
        }
    ...
    setStorage(id) {
        ...
        const checkbox = document.querySelector(`.${randomCheckbox}`);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   TextForm: () => (/* binding */ TextForm)
/* harmony export */ });
/* harmony import */ var _utils_db__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/db */ "./src/js/utils/db.ts");
/* harmony import */ var _list__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./list */ "./src/js/components/list.ts");
/* harmony import */ var _popup__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./popup */ "./src/js/components/popup.ts");
...
class TextForm {
    ...
    init() {
        if (this.element) {
            ...
            this.popUp = new _popup__WEBPACK_IMPORTED_MODULE_2__.Popup(document.querySelector('.js-popup'));
            this.list = new _list__WEBPACK_IMPORTED_MODULE_1__.List(document.querySelector('.js-list'));
            this.createEvents();
        }
    }
    createEvents() {
    ...
    submitForm() {
        if (this.input.value) {
            ...
            (0,_utils_db__WEBPACK_IMPORTED_MODULE_0__.addToDb)(newData);
...
/*!**************************!*\
  ...
  \**************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_textForm__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/textForm */ "./src/js/components/textForm.ts");
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    new _components_textForm__WEBPACK_IMPORTED_MODULE_0__.TextForm(document.querySelector('.js-add-text-form'));
});
